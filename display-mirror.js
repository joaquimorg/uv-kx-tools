...
const baudSelect = document.getElementById("mirrorBaudSelect");
...
const updateAttachment = () => {
  ...
  if (isAttached) {
    ...
    setStatus(
      ...
      isConnected ? "Mirror idle." : "No serial port selected.",
    );
  }
  updateControls();
};
